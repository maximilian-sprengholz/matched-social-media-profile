...
group: List containing the id of the HTML div, the label and icon (fa ref)
       displayed
print: Function.
       - df (dataframe): Pass the df when you need the values of other variables than the one
         printed
       - value: value of printed var
       - header (bool): specifies if printed in header or not
...
matchvarparams <- dict(list(
    ...
    currentstate = dict(list(
        ...
        group = list(id="location", label="Ort und Herkunft", icon="fa-house-chimney-window"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    marital = dict(list(
        ...
        group = list(id="family", label="Familie", icon="fa-family"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    employment = dict(list(
        ...
        group = list(id="finance", label="Finanzen", icon="fa-money-check-dollar"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    workorplay = dict(list(
        ...
        group = list(id="personality", label="Persönlichkeit", icon="fa-face-smile"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    snooze = dict(list(
        ...
        group = list(id="behavior", label="Verhalten", icon="fa-head-side"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    color = dict(list(
        ...
        group = list(id="taste", label="Geschmack", icon="fa-star"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    vacation = dict(list(
        ...
        group = list(id="thingsyoudo", label="Dinge, die ich mache", icon="fa-head-side-heart"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
    ...
    musiclisten = dict(list(
        ...
        group = list(id="thingsyoulike", label="Dinge, die ich mag", icon="fa-heart-pulse"),
        print = function(df=NA, value=NA, header=FALSE, t=c()) {
            if (header == TRUE) {
                return(list(track=t, print=paste0(value)))
            } else {
