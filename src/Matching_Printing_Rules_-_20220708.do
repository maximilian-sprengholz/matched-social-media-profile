...
use "$data/DE_82803 D-P21-13185 HU Berlin Impfskeptiker_Welle 6_Finale Daten", clear
...
cap drop general1
gen str general1 = ""
replace general1 = "Meine Augenfarbe ist" + " " +  str_eyecolor + " " + "und ich bin" + " "+ str_hand + "."
...
cap drop general3
gen str general3 = ""
replace general3 = str_land + " " + "Meine Muttersprache ist" + " " + str_language + " " + "und ich spreche" + " " + str_other_languages + "."
...
cap drop verhalten2
gen str verhalten2 = ""
replace verhalten2 = str_wegwerfen
...
cap drop verhalten3
gen str verhalten3 = ""
replace verhalten3 = str_sperrmüll
...
cap drop verhalten4
gen str verhalten4 = ""
replace verhalten4 = str_geschenk
...
cap drop verhalten5
gen str verhalten5 = ""
replace verhalten5 = "Die Schlummertaste beim Wecker kann ja Fluch und Segen zugleich sein. Bei mir ist es so, dass ich die Schlummertaste normalerweise" + " " + str_snoozing + "."
replace verhalten5 = "" if v_748 == 99 
...
cap drop verhalten6
gen str verhalten6 = ""
replace verhalten6 = str_diebstahl
replace verhalten6 = "" if v_751 == 3
...
cap drop verhalten7
gen str verhalten7 = ""
replace verhalten7 = "Für viele Menschen gehören Schimpfwörter mittlerweile zum Sprachgebrauch dazu. Bei mir ist es so, dass" + " " + str_fluchen + " " + "Schimpfwörter verwende."
...
cap drop verhalten8
gen str verhalten8 = ""
replace verhalten8 = "Horoskope sind ja so eine Sache. Ich muss sagen, dass" + " " + str_horoskop + "."
...
cap drop like1
gen str like1 = ""
replace like1 = "Ob ich Social Media verwende? Ich würde sagen, dass ich" + " " + str_social_media + " " + "bin."
...
cap drop hobbies1
gen str hobbies1 = ""
replace hobbies1 = str_musik + " " + musik_Blues + musik_Klassik + musik_Country + musik_Rock + musik_HipHop + musik_Latin + musik_Pop + musik_Religiös + musik_Funk + musik_R_B + musik_Rap + musik_Elektronisch + musik_Folk + musik_Jazz + musik_New_Age + musik_Reggae
...
cap drop hobbies2
gen str hobbies2 = ""
replace hobbies2 = "Ich bin großer Fan von " + " " + str_musik_liebling + "."
...
cap drop hobbies3
gen str hobbies3 = ""
replace hobbies3 = str_filme + " " + filme_Action + filme_Abenteuer + filme_Komödie + filme_Krimi + filme_Drama + filme_Fantasy + filme_Historisch + filme_Horror + filme_Mystery + filme_Politisch + filme_Romantik + filme_SciFi + filme_Thriller + filme_Krieg + filme_Western + filme_Surreal
...
cap drop hobbies4
gen str hobbies4 = ""
replace hobbies4 = "Mein absoluter Lieblingsfilm ist" + " " + "'" + str_filme_liebling + "'" + " " + "und am liebsten sehe ich Filme mit" + " " + str_schauspieler_liebling + "."
...
cap drop hobbies5
gen str hobbies5 = ""
replace hobbies5 = str_fan + " " + fan_Golf + fan_Fußball + fan_Baseball + fan_Basketball + fan_Volleyball + fan_Tennis + fan_Eishockey + fan_Cricket + fan_American_Football + fan_Feldhockey + fan_Nascar + fan_Formel_1 + fan_Radfahren + fan_Darts + fan_Snooker + fan_Boxen + fan_Andere
...
cap drop hobbies6
gen str hobbies6 = ""
replace hobbies6 = "Ich bin großer Fan von" + " " + str_fan_liebling + "."
replace hobbies6 = "" if str_fan_liebling == "-66"
...
cap drop hobbies7
gen str hobbies7 = ""
replace hobbies7 = str_fernsehen + " " + str_fernsehen_liebling
...
cap drop hobbies8
gen str hobbies8 = ""
replace hobbies8 = str_buch + " " + str_buch_liebling
...
cap drop hobbies9
gen str hobbies9 = ""
replace hobbies9 = str_web + " " + str_web_liebling
...
cap drop hobbies10
gen str hobbies10 = ""
replace hobbies10 = str_video + " " + str_video_liebling
...
cap drop hobbies11
gen str hobbies11 = ""
replace hobbies11 = str_kreativ + " " + str_kreativ_liebling
