...
matchparams <- dict(list(
    ...
    demography = dict(list(
        ...
        items = dict(list(
            ...
            righthanded = dict(list(
                weight = function(value=NA, common=0) {
                    if (value == "Rechtsh�nder") return(5)
                    if (value == "Linksh�nder") return(20)
                    return(30)
                    }
                )),
            language = dict(list(
        ...
        items = dict(list(
            ...
            secondgen = dict(list(
                weight = function(value=NA, common=0) {
                    ...
                    if (value == "Ja, Gro�eltern") return(15)
                    }
                )),
    ...
    finance = dict(list(
        ...
        items = dict(list(
            ...
            studentdebt = dict(list(
                weight = function(value=NA, common=0) {
                    if (value == "Ja, und sie sind gro�") return(30)
                    if (value == "Ja, aber sie sind �berschaubar") return(20)
    ...
    personality = dict(list(
        hl = list(label="Pers�nlichkeit", icon="fa-face-smile"),
        items = dict(list(
        ...
        items = dict(list(
            ...
            profanelanguage = dict(list(
                weight = function(value=NA, common=0) {
                    ...
                    if (value == "Regelm��ig") return(30)
                    }
                )),
            readhoroscope = dict(list(
                weight = function(value=NA, common=0) {
                    if (value == "T�glich") return(30)
                    if (value == "W�chentlich") return(15)
        ...
        items = dict(list(
            ...
            spicyfood = dict(list(
                weight = function(value=NA, common=0) {
                    ...
                    if (value == "W�rzig, aber nicht zu viel") return(10)
        ...
        items = dict(list(
            ...
            smoke = dict(list(
                weight = function(value=NA, common=0) {
                    ...
                    if (value == "Nein, ich habe aufgeh�rt") return(25)
                    }
                )),
            sportdo = dict(list(
                split = ", ",
    ...
    # Quirk
    # quirk = dict(list(
    #     hl = list(label="Ein interessanter Fakt �ber mich", icon="fa-face-surprise"),
    #     items = dict(list(
    #         otherfun = dict(list(
