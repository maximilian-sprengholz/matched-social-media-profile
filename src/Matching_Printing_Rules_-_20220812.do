...
cap drop eyes 
gen str eyes = ""
replace eyes = v_882_print
replace eyes = ustrlower(eyes)
replace eyes = "braun" if v_687 == 1
replace eyes = "blau" if v_688 == 1
replace eyes = "grün" if v_689 == 1
replace eyes = "" if v_882_print == " "

cap drop demography1
gen str demography1 = ""
replace demography1 = "Meine Augenfarbe ist" + " " +  eyes + "." 
replace demography1 = "" if eyes == "" 
...
replace righthanded = "Linkshänderin" if righthanded == "Linkshänder" & v_16 == 1
replace righthanded = "Rechtshänderin" if righthanded == "Rechtshänder" & v_16 == 1
replace righthanded = "beidhändig" if righthanded == "Beidhändig" & v_16 == 1

cap drop demography2
gen str demography2 = ""
replace demography2 = "Ich bin" + " " + righthanded + "."
...
* family3
cap drop children
tostring v_144, gen(children)
replace children  = "keine" if v_144 == 0
replace children  = "zwei" if v_144 == 2
replace children  = "drei" if v_144 == 3
replace children  = "vier" if v_144 == 4
replace children  = "fünf" if v_144 == 5
replace children  = "sechs" if v_144 == 6
replace children  = "sieben" if v_144 == 7
replace children  = "acht" if v_144 == 8
replace children  = "neun" if v_144 == 9
replace children  = "zehn" if v_144 == 10
replace children  = "elf" if v_144 == 11
replace children  = "zwölf" if v_144 == 12
replace children = children + " " + "eigene Kinder"
replace children  = "ein eigenes Kind" if v_144 == 1
replace children  = "" if v_144 == -66
replace children  = "" if v_144 == -99
...
cap drop incomeclass_change
gen str incomeclass_change = ""
replace incomeclass_change = "ein Aufstieg" if v_733 > v_734
replace incomeclass_change = "ein Abstieg" if v_734 > v_733
replace incomeclass_change = "keine Veränderung" if v_733 == v_734
...
cap drop finance1
gen str finance1 = ""
replace finance1 = "Ich zähle mich zur" + " " + incomeclass  + "." + " " + "Im Vergleich zu meinen Eltern ist dies" + " " + incomeclass_change + "." + " " + "Für die Zukunft denke ich, dass ich mich in der" + " " + incomeclassfuture  + " " + "wiederfinden werde."
...
cap drop finance2
gen str finance2 = ""
replace finance2 = "Ich besitze" + " " + owncar  + "." 
...
cap drop finance3
gen str finance3 = ""
replace finance3 = "Ich besitze" + " " + ownhouse  + "." 
...
replace personality1 = "Sich selbst zu beschreiben ist ja oftmals gar nicht so einfach. Ich würde aber sagen, dass ich eher" + " " + patient + " " + "Mensch bin."
...
cap drop color 
gen str color = ""
replace color = "Meine Lieblingsfarbe ist:" + " " + lower(str_v_756) + "."
replace color = "Meine Lieblingsfarbe ist:" + " " + lower(v_893_print) + "." if v_756 == 12

cap drop taste0
gen str taste0 = ""
replace taste0 = color 
...
cap drop food 
gen str food  = ""
replace food  = "Ich esse am liebsten" + " " + str_v_758 + "." if v_758 != 16 &  v_758 != 99
replace food  = "Am liebsten esse ich:" + " " +  v_894_print + "." if v_758 == 16 &  v_758 != 99
replace food  = "Ich habe kein bestimmtes Lieblingsessen." if v_758 == 99
replace food  = "" if v_894_print == " "
...
save "$data/Data_with_printing_rules_20220812", replace
